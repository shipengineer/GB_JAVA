...
public class Bandit extends Warrior {
    ...
    public Bandit(String name, float hp, int maxHp, int attack, int damageMin, int damageMax, int defense, int speed,
    ...
    public StringBuilder getInfo() {
        ...
        return builder.append("Бандит: \t").append(Bandit.super.name)
                ...
                .append(" \t|\t\t\t|").append("\t| (X.Y) : ").append(Bandit.super.coords.posX).append(".")
                .append(Bandit.super.coords.posY);
    }
}
